...
if (!class_exists('EG_Plugin_109')) {
	...
	Class EG_Plugin_109 {
		...
		/**
		  ...
		  *
		  */
		function EG_Plugin_109($name, $version, $core_file, $options_entry, $default_options=FALSE) {
		 ...
		 * @return 	none
		 */
		function cache_set($key, $data, $flag = 'default', $expire = 0) {
